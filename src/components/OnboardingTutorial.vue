...
const steps = [
  {
    ...
    details: [
      ...
      'ใส่เลขย้อนหลังและคำนวณ',
      'วิเคราะห์ข้อมูลด้วย AI',
      'ทำนายเลขเด่นแม่นยำสูง',
    ],
  },
  {
    emoji: '🎯',
    title: 'หน้าหลัก - ทำนายหวย',
    description: 'เลือกหวยและคำนวณเลขเด่น',
    details: [
      '1. เลือกประเภทหวย (ลาว/รัฐบาล/ฮานอย)',
      '2. กรอกเลขย้อนหลัง มากกว่า 3 งวด',
      '3. กดปุ่ม "คำนวณด้วย 9 สูตร"',
      '4. ดูผลลัพธ์ เลขเด่น, 2 ตัว, 3 ตัว',
    ],
    highlight: '💡 ยิ่งใส่เลขย้อนหลังเยอะ ระบบวิเคราะห์ยิ่งแม่นยำ',
  },
  {
    emoji: '🎁',
