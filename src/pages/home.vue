    ...
    <div class="max-w-2xl mx-auto">
      ...
      <div class="text-center mb-6">
        ...
        <div class="mt-4 flex items-center justify-center gap-2">
          <div class="px-6 py-3 rounded-xl font-bold text-sm bg-gradient-to-r from-green-500 to-emerald-600 text-white shadow-lg">
            💎 โหมดปกติ
          </div>
          <button
            @click="router.push('/precision')"
            class="px-6 py-3 rounded-xl font-bold text-sm transition-all shadow-lg bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:scale-105 hover:bg-gradient-to-r hover:from-purple-500 hover:via-pink-500 hover:to-blue-600 hover:text-white"
          >
            🎯 Precision Mode
          </button>
        </div>
      ...
      <div v-if="hotNumbers.length" class="space-y-6">
        ...
        <!-- Buy Numbers CTA - Enhanced Version -->
        <div class="relative group mt-8">
          ...
          <div class="relative bg-gradient-to-br from-red-500 via-pink-500 to-purple-600 rounded-3xl p-8 shadow-2xl overflow-hidden">
